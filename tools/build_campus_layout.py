...
OBSTACLES: list[dict] = [
    ...
    dict(id="nw-pod-wall", rect=(482, 244, 498, 426)),
    dict(id="ne-pod-wall", rect=(1000, 244, 1018, 426)),
    ...
    dict(id="sw-pod-bottom-post", rect=(558, 746, 594, 804)),
    dict(id="sw-plant", rect=(495, 644, 540, 730)),
    dict(id="sw-planter", rect=(484, 574, 602, 636)),
    dict(id="sw-desk", rect=(530, 648, 686, 750)),
    dict(id="se-pod-wall", rect=(998, 574, 1016, 786)),
    dict(id="se-pod-bottom-wall", rect=(906, 746, 1016, 788)),
    dict(id="se-pod-bottom-post", rect=(906, 746, 942, 804)),
