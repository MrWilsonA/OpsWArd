...
TARGETS = {
    ...
    "vault_behind_racks": (220, 228),
    "security_watch": (200, 600),
    "archive_library": (270, 930),
    "archive_behind_shelf": (120, 916),
    "archive_east_aisle": (461, 700),
    "archive_beside_plant": (461, 730),
    "data_garden": (1110, 300),
    "garden_behind_boxes": (1250, 150),
    "briefing_room": (1130, 600),
    "briefing_behind_cabinets": (1250, 458),
    "pantry_lounge": (1040, 800),
    "pantry_behind_counter": (1150, 750),
    "central_north": (752, 220),
    "central_table_north": (752, 400),
